...
This assembler targets an extended Brookshear Machine, based on the machine described in *Computer Science: An Overview, 13th edition*, by J. Glenn Brookshear and extended with four additional instructions.
