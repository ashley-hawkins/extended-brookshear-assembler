...
Consecutive data bytes are _not_ aligned to a 2-byte boundary like regular instructions are. They are tightly packed according to however many bytes of data they declare.

## CONST pseudo-instruction
...
## Addresses, labels, and constants
